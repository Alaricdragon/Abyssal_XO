package Abyssal_XO.data.scripts.threat.specalItems;
...
public class NanoThief_BlackBox extends BaseSpecialItemPlugin{
    ...
    protected String getRightClickRuleTrigger() {
        return "abyssal_XO_BlackBoxStart";
    }
    ...
    public void performRightClickAction(RightClickActionHelper helper) {
        ...
        Global.getSector().getCampaignUI().showInteractionDialogFromCargo(plugin,
                Global.getSector().getPlayerFleet(), new CampaignUIAPI.DismissDialogDelegate() {
                    @Override
