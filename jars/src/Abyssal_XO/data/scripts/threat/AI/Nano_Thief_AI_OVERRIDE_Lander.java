...
public class Nano_Thief_AI_OVERRIDE_Lander {
    private static Logger log = Global.getLogger(Nano_Thief_AI_OVERRIDE_Lander.class);
    private static ArrayList<Nano_Thief_AI_OVERRIDE_Lander> wings;
    public static void reset(){
        wings = new ArrayList<>();
    }
    public static void advanceAll(float amount){

        for (Nano_Thief_AI_OVERRIDE_Lander wing : wings){
            wing.advance(amount);
        }
    }
    ...
    public Nano_Thief_AI_OVERRIDE_Lander(ShipAPI ship, Nano_Thief_Stats stats){
    ...
    private ShipAPI getClosestHostile(){
        return null;//getClosestHostile(range+2000000);
    }
